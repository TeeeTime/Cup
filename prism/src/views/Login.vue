...
<template>
  ...
  <div class="login-wrapper">
    ...
    <Card :noHover="true" class="login-card">
      ...
      <div v-if="!isWaitingForPopup" class="content">
        <h1 class="brand-title">teaz.fun</h1>
        <p class="subtitle">Access your dashboard</p>

        <!-- Using your custom BaseButton and passing the primary color variant -->
        <BaseButton color="primary" @click="triggerDiscordLogin">
      ...
      <div v-else class="content waiting">
        <div class="spinner"></div>
        <h2 class="waiting-title">Authenticating...</h2>
        <p class="subtitle">Please complete the login in the popup window.</p>
      </div>
